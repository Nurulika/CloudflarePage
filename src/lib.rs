// src/lib.rs
/*
 * Core library for CloudflarePage
 */
...
#[derive(Debug)]
pub struct CloudflarePageProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CloudflarePageProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CloudflarePage processing");
    
    let mut processor = CloudflarePageProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CloudflarePageProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CloudflarePageProcessor::new(false);
